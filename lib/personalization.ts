...
export class PersonalizationEngine {
  ...
  private extractInterestsFromPage(page: string): string[] {
    ...
    if (page.includes('/products/')) {
      if (page.includes('cogniassist')) interests.push('conversational-ai');
      if (page.includes('cognixcellerate')) interests.push('agentic-ai');
      if (page.includes('cogniloom')) interests.push('document-processing');
    }
