      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {industries.map((industry, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Card padding="lg" className="h-full flex flex-col hover:shadow-lg transition-all duration-300 hover:shadow-yellow-100 border-l-4 border-l-yellow-400">
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-12 h-12 bg-yellow-100 rounded-lg flex items-center justify-center">
                  <industry.icon className="w-6 h-6 text-yellow-600" />
                </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {industry.solutions.map((solution) => (
                    <span
                      key={solution}
                      className="px-2 py-1 bg-yellow-50 text-xs font-medium text-yellow-700 rounded border border-yellow-200"
                    >
                      {solution}
                    </span>
                  ))}
              ...
              <Button variant="outline" className="self-start mt-auto border-yellow-400 text-yellow-600 hover:bg-yellow-400 hover:text-black">
                Explore Solutions →
              </Button>
            </Card>
          </motion.div>
