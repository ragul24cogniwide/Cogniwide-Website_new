...
const IndustryIntegration = () => {
  ...
  return (
    <Section background="white" padding="lg" className="bg-gradient-to-br from-yellow-50 to-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
          {integrationPoints.map((point, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card padding="lg" className="hover:shadow-lg transition-all duration-300 hover:shadow-yellow-100 border-l-4 border-l-yellow-400">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-center">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="w-8 h-0.5 bg-yellow-400 hidden lg:block" />
                    <div className="w-3 h-3 bg-yellow-400 rounded-full mx-2" />
                    <div className="w-8 h-0.5 bg-yellow-400 hidden lg:block" />
                  </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Card padding="lg" className="bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-6 py-3 bg-yellow-500 text-black font-semibold rounded-lg hover:bg-yellow-600 transition-colors shadow-lg shadow-yellow-500/25">
                Schedule Industry Demo
              </button>
              <button className="px-6 py-3 border border-yellow-500 text-yellow-600 font-semibold rounded-lg hover:bg-yellow-50 transition-colors">
                Explore Solutions
              </button>
            </div>
          </Card>
