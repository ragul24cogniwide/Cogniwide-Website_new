      ...
      <div className="relative bg-gray-800/90 rounded-2xl shadow-2xl p-8 border border-yellow-400/20">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-gray-400/10 rounded-lg p-4 text-center border border-yellow-400/20">
              <div className="text-2xl font-bold text-yellow-400">156</div>
              <div className="text-xs text-yellow-300">Students</div>
            </div>
            <div className="bg-gray-400/10 rounded-lg p-4 text-center border border-blue-400/20">
              <div className="text-2xl font-bold text-yellow-400">92%</div>
              <div className="text-xs text-yellow-300">Engagement</div>
            </div>
            <div className="bg-gray-400/10 rounded-lg p-4 text-center border border-blue-400/20">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg border border-blue-400/10">
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-yellow-400 rounded-full flex items-center justify-center">
                  <div className="w-2 h-2 bg-black rounded-full"></div>
                </div>
              ...
              <span className="text-xs text-yellow-400 font-medium">Learning</span>
            </div>
          </div>
        </div>
      </div>
