...
const InteractiveDemo = ({ 
  productName, 
  title = `${productName} Interactive Demo`,
  ...
  const getProductSteps = () => {
    switch (productName) {
      case 'CogniAgent':
        return [
          { title: 'Define Agents', description: 'Create specialized AI agents for different tasks', visual: 'agent-creation', icon: <AgentIcon /> },
          { title: 'Design Workflow', description: 'Build multi-agent collaboration workflows', visual: 'workflow-design', icon: <WorkflowIcon /> },
          { title: 'Set Triggers', description: 'Configure automation triggers and conditions', visual: 'trigger-config', icon: <LightningIcon /> },
          { title: 'Monitor & Scale', description: 'Deploy agents and monitor performance', visual: 'monitoring', icon: <ChartIcon /> }
        ]
      case 'CogniKube':
        return [
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center px-4 py-2 bg-yellow-100 text-yellow-800 rounded-full text-sm font-medium mb-4"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 shadow-xl border border-gray-100">
                  ...
                  <motion.div
                    ...
                    className={`group p-4 rounded-xl cursor-pointer transition-all duration-300 ${
                      activeStep === index 
                        ...
                        : 'bg-white border-2 border-gray-100 hover:border-yellow-200 hover:shadow-sm'
                    }`}
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <div className={`font-semibold transition-colors duration-300 ${
                          activeStep === index ? 'text-gray-900' : 'text-gray-700 group-hover:text-gray-900'
                        }`}>{step.title}</div>
              ...
              <Button 
                ...
                onClick={playDemo}
                disabled={isPlaying}
                className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
              >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-xl border border-gray-100 h-full">
              <div className="aspect-video bg-gradient-to-br from-yellow-50 to-yellow-25 rounded-xl flex items-center justify-center mb-8 border border-yellow-100 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-100/20 to-transparent"></div>
                {/* Product-Specific Demo Visualization */}
                <motion.div
                  className="text-center w-full h-full flex flex-col items-center justify-center p-6 relative z-10"
                  key={activeStep}
                ...
                >
                  ...
                  {productName === 'CogniAgent' && (
                    <div className="w-full">
                      <motion.div 
                        className="w-20 h-20 bg-gradient-to-br from-blue-400 to-blue-500 rounded-2xl flex items-center justify-center mb-6 mx-auto text-white shadow-lg"
                        animate={{ 
                          scale: [1, 1.05, 1],
                          rotate: [0, 2, -2, 0]
                        }}
                      ...
                      <div className="grid grid-cols-3 gap-3 mb-6">
                        {[1, 2, 3].map((i) => (
                          <motion.div 
                            key={i} 
                            className={`h-10 rounded-xl ${activeStep >= i - 1 ? 'bg-blue-400' : 'bg-gray-200'} flex items-center justify-center shadow-sm`}
                            animate={activeStep >= i - 1 ? { scale: [1, 1.05, 1] } : {}}
