...
const products = [
  ...
  },
  {
    ...
    description: 'Automate document workflows with AI-powered extraction, classification, and processing capabilities.',
    features: ['Document AI', 'Workflow Automation', 'OCR & NLP', 'Integration Ready'],
    icon: BeakerIcon,
    color: 'from-orange-500 to-red-500'
  },
  {
    name: 'CogniXcellerate',
    slug: 'cognixcellerate',
    tagline: 'AI-Powered Development Acceleration',
    description: 'Accelerate software development with AI-powered code generation, testing, and deployment automation.',
    features: ['Code Generation', 'Automated Testing', 'CI/CD Integration', 'Quality Assurance'],
    icon: CogIcon,
