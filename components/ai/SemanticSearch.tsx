...
const SemanticSearch = () => {
  ...
  const searchData: SearchResult[] = [
    {
      id: '1',
      title: 'CogniAssist - Conversational AI Platform',
      description: 'Build intelligent chatbots and virtual assistants without code. Deploy across multiple channels.',
      type: 'product',
    ...
    {
      id: '2',
      title: 'CogniXcellerate - Agentic AI Platform',
      description: 'Orchestrate AI agents at enterprise scale for complex business process automation.',
      type: 'product',
      url: '/products/cognixcellerate',
      relevanceScore: 0.92,
      category: 'AI Products'
    },
    {
      id: '3',
      title: 'CogniLoom - Document Processing',
      description: 'Transform documents into actionable intelligence with AI-powered data extraction.',
      type: 'product',
