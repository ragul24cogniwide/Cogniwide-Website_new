...
export const metadata: Metadata = {
  title: 'Retail & E-commerce AI Solutions | Cogniwide',
  ...
  keywords: ['retail AI', 'e-commerce automation', 'personalization', 'inventory management', 'customer experience'],
};
...
const successMetrics = [
  {
    ...
    value: '35%',
    description: 'Average increase in e-commerce conversion rates',
    icon: 'shopping-cart',
    trend: 'up' as const,
