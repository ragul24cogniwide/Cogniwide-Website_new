...
const CogniVibePage = () => {
  return (
    <PageLayout>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="text-left"
            >
              <div className="inline-flex items-center bg-brand-yellow/20 text-brand-yellow px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              <div className="relative">
                ...
                <div className="bg-gradient-to-br from-brand-yellow to-yellow-400 rounded-3xl p-8 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <div className="bg-brand-black/10 rounded-2xl p-6 backdrop-blur-sm">
                    ...
                    <h3 className="text-xl font-bold text-brand-black text-center mb-2">AI Control Center</h3>
                    <p className="text-brand-black/80 text-sm text-center">Orchestrating your entire pipeline</p>
                  </div>
                </div>
            ...
            {[
              {
                ...
                icon: ChartBarIcon,
                gradient: "from-brand-yellow to-yellow-400",
              ...
              <motion.div
                ...
                className={`relative overflow-hidden ${feature.bgColor} p-6 rounded-2xl border border-brand-yellow/20 hover:shadow-lg transition-all duration-300 group hover:-translate-y-1`}
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-bold text-brand-yellow mb-2 group-hover:text-brand-white transition-colors duration-200">{feature.title}</h3>
                    <p className="text-brand-white text-sm leading-relaxed">{feature.description}</p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="text-center bg-brand-yellow p-8 rounded-xl shadow-lg border border-brand-yellow/20"
              >
                <div className="text-4xl font-bold text-brand-black mb-2">{stat.metric}</div>
                <div className="text-lg font-semibold text-brand-black mb-2">{stat.label}</div>
                <div className="text-brand-black">{stat.description}</div>
              </motion.div>
            ))}
          </div>
        </div>
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center mb-6">
                    <div className="w-12 h-12 bg-brand-yellow text-brand-black rounded-full flex items-center justify-center font-bold text-lg mr-4">
                      {step.step}
                    </div>
                    <h3 className="text-2xl font-bold text-brand-yellow">{step.title}</h3>
                  </div>
                  <p className="text-lg text-brand-white mb-6">{step.description}</p>
                  <div className="grid grid-cols-2 gap-4">
                    {step.features.map((feature, idx) => (
                      <div key={idx} className="flex items-center">
                        <CheckCircleIcon className="w-5 h-5 text-brand-yellow mr-2" />
                ...
                <div className="flex-1">
                  <div className="bg-gradient-to-br from-brand-dark-grey to-brand-black/50 rounded-2xl p-8 h-80 flex items-center justify-center border border-brand-yellow/20 relative overflow-hidden">
                    {/* Background Pattern */}
                    <div className="absolute inset-0 opacity-10">
                      <div className="absolute top-4 left-4 w-2 h-2 bg-brand-yellow rounded-full"></div>
                      <div className="absolute top-8 right-8 w-1 h-1 bg-brand-yellow rounded-full"></div>
                      <div className="absolute bottom-6 left-8 w-1.5 h-1.5 bg-brand-yellow rounded-full"></div>
                      <div className="absolute bottom-4 right-4 w-2 h-2 bg-brand-yellow rounded-full"></div>
                    </div>
                    
                    {/* Step-specific illustrations */}
                    {step.image === 'planning' && (
                      <div className="relative z-10">
                        <svg className="w-48 h-48 text-brand-yellow" viewBox="0 0 200 200" fill="none">
                          {/* Project Board */}
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="flex-shrink-0 w-40 p-6 rounded-lg shadow-soft hover:shadow-medium transition-all duration-300 flex flex-col items-center justify-center group hover:scale-105"
                >
                  <Image 
                  ...
                  />
                  <span className="font-medium text-brand-black text-sm text-center">{tool.name}</span>
                </motion.div>
              ))}
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-brand-black via-brand-dark-grey to-brand-black relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-64 h-64 bg-brand-yellow rounded-full blur-3xl"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center bg-brand-yellow/20 text-brand-yellow px-6 py-3 rounded-full text-sm font-semibold mb-6">
              <ChartBarIcon className="w-5 h-5 mr-2" />
              Real Results
            </div>
            <h2 className="text-5xl md:text-6xl font-bold text-brand-white mb-6">
              Proven Impact &
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-brand-yellow to-yellow-400">
                Performance
              </span>
            </h2>
            ...
            {[
              {
                ...
                icon: RocketLaunchIcon,
                gradient: "from-brand-yellow to-yellow-400",
                bgGradient: "from-brand-yellow/10 to-yellow-400/10"
              },
              {
                metric: "85%",
                label: "Bug Reduction",
              ...
              <motion.div
                ...
                className="relative bg-brand-black/80 backdrop-blur-sm rounded-3xl p-8 text-center group hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl border border-brand-yellow/30"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-brand-yellow/10 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div className="relative">
                  <div className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br ${item.gradient} mb-6 shadow-lg`}>
                    <item.icon className="w-10 h-10 text-brand-black" />
                  </div>
                  <div className={`text-5xl font-bold mb-3 bg-gradient-to-br ${item.gradient} bg-clip-text text-transparent`}>
                    {item.metric}
                  </div>
                  <h3 className="text-xl font-bold text-brand-white mb-3">{item.label}</h3>
                  <p className="text-brand-light-grey text-sm leading-relaxed">{item.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="bg-gradient-to-r from-brand-dark-grey to-brand-black rounded-3xl p-12 text-center text-white relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-brand-yellow/10 to-brand-yellow/5 opacity-50"></div>
            <div className="relative">
              <h3 className="text-3xl font-bold mb-6 text-brand-white">Trusted by Industry Leaders</h3>
              <p className="text-xl text-brand-light-grey mb-8 max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                {["TechCorp", "InnovateLabs", "DevSolutions", "CloudFirst", "AgileWorks"].map((company, index) => (
                  <div key={company} className="text-lg font-semibold text-brand-yellow">{company}</div>
                ))}
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-20 bg-brand-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-brand-yellow mb-4">
              Unified SDLC Automation
            </h2>
            <p className="text-lg md:text-xl text-brand-white max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
            {[
              ...
              >
                <div className={`${stage.bgColor} rounded-2xl p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-brand-yellow/20 text-center`}>
                  <div className={`${stage.color} rounded-xl p-3 w-fit mx-auto mb-3 group-hover:scale-110 transition-transform duration-300`}>
                    <stage.icon className="w-6 h-6 text-brand-black" />
                  </div>
                  <h3 className="text-sm font-bold text-brand-yellow mb-1 group-hover:text-brand-white transition-colors duration-200">
                    {stage.stage}
                  </h3>
                  <p className="text-xs text-brand-white leading-tight">
                    {stage.description}
                  </p>
                </div>
                ...
                {index < 5 && (
                  <div className="hidden lg:block absolute top-1/2 -right-2 transform -translate-y-1/2 z-10">
                    <div className="w-4 h-0.5 bg-brand-yellow opacity-60"></div>
                  </div>
                )}
              </motion.div>
            ))}
          ...
          >
            <div className="bg-gradient-to-br from-brand-yellow to-yellow-400 rounded-2xl p-8 shadow-strong max-w-md text-center">
              <div className="relative mb-4">
                <CogIcon className="w-12 h-12 text-brand-black mx-auto animate-spin [animation-duration:8s]" />
                <div className="absolute -top-1 -right-1 w-4 h-4 bg-green-500 rounded-full animate-pulse"></div>
              </div>
              <h3 className="text-xl font-bold text-brand-black mb-2">AI Control Center</h3>
          ...
          >
            {[
              ...
              <motion.div 
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="text-center p-6 bg-brand-black rounded-xl shadow-soft hover:shadow-medium transition-all duration-300 border border-brand-yellow/20"
              >
                <div className={`inline-flex items-center justify-center w-16 h-16 ${benefit.color} rounded-full mb-4`}>
                  <benefit.icon className="w-8 h-8 text-brand-black" />
                </div>
                <h3 className="text-xl font-bold text-brand-yellow mb-3">{benefit.title}</h3>
                <p className="text-brand-white leading-relaxed">{benefit.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-brand-dark-grey mb-8">
              Join thousands of development teams who have accelerated their delivery with CogniVibe's AI-powered SDLC framework.
            </p>
