...
import CogniKubeDiagram from '@/components/products/CogniKubeDiagram';

import { CTASection } from '@/components/home/CTASection';

export const metadata: Metadata = {
  title: 'CogniKube - AI-Powered Kubernetes Orchestration Platform | Cogniwide',
...
const productData = {
  ...
  benefits: [
    ...
    'Minimize manual operations by 85%'
  ],
  useCases: [
...
export default function CogniKubePage() {
  return (
    <PageLayout>
      <ProductHero product={productData} />
      <InteractiveDemo productName="CogniKube" />
      <BeforeAfterComparison 
        productName="CogniKube"
        before={{
          title: 'Traditional DevSecOps Practices',
          points: [
            'Fragmented tools across CI/CD, security, and observability stacks',
            'Manual debugging and incident triage slowing down MTTR',
            'Reactive scaling leading to performance inefficiencies',
            'Disconnected visibility across multi-cloud clusters and pipelines',
            'Lack of proactive compliance and risk insights',
            'High operational overhead and dependency on specialized expertise',
            'Limited collaboration between Dev, Sec, and Ops teams',
            'Slow onboarding and manual environment configuration ',
            'No performance metrics or insights',
            'Inefficient cost management'
          ]
        }}
        after={{
          title: 'With CogniKube',
          points: [
            'Unified platform integrating Dev, Sec, and Ops workflows',
            'AI-assisted debugging and faster incident resolution',
            'Predictive scaling and optimized resource utilization',
            'Centralized observability with unified metrics and logs',
            'Continuous compliance and real-time vulnerability detection',
            'Automated workflows with self-healing capabilities',
            'Seamless collaboration through AI-powered ChatOps',
            'Intelligent onboarding and automated environment setup',
            'Built-in DORA metrics and operational analytics ',
            'Dynamic cost visibility and optimization across clouds'
          ]
        }}
      />
      
      <ArchitectureDiagram productName="CogniKube" />
      <CogniKubeDiagram />
