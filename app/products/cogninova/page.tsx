...
export default function CogniNovaPage() {
  return (
    <PageLayout>
      ...
      <InteractiveDemo productName="CogniNova" />
      ...
      <ArchitectureDiagram productName="CogniNova" />
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Integrated management system handling admissions, attendance, grades, scheduling, and communication - all powered by AI for maximum efficiency and insights.</p>
                  </div>
                </div>
              </div>
            </div>
