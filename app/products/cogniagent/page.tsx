...
export const metadata: Metadata = {
  title: 'CogniAgent - AI-Powered Agentic Automation Platform | Cogniwide',
...
export default function CogniAgentPage() {
  return (
    <PageLayout>
      <ProductHero product={productData} />
      <InteractiveDemo productName="CogniAgent" />
      ...
      />
      <ArchitectureDiagram productName="CogniAgent" />
      <CogniAgentDiagram />
      <CTASection />
    </PageLayout>
  );
